...
[source, java]
----
include::{programsdir}/NestedExpressions.java[lines=1..12]
----

This first section of code is a utility method that takes the right-side
version of a symbol and returns the left-side version.

[source, java]
----
include::{programsdir}/NestedExpressions.java[lines=13..18]
----
...
[source, java]
----
include::{programsdir}/NestedExpressions.java[lines=19..31]
----
...
checks to see if the top is the left-side version of the current symbol.
If the stack is empty or its top doesn't match, `correct` is set to `false`.
For efficiency, the loop stops early if `correct` is no longer `true`.

[source, java]
----
include::{programsdir}/NestedExpressions.java[lines=33..43]
----
