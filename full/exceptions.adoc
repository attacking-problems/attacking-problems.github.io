...
public static Color changeColor(Color color) {
    ...
    try {
        switch (in.next().trim().charAt(0)) {
            case 'R' -> color = increaseRed(color);
            case 'G' -> color = increaseGreen(color);
            case 'B' -> color = increaseBlue(color);
            case 'r' -> color = decreaseRed(color);
            case 'g' -> color = decreaseGreen(color);
            case 'b' -> color = decreaseBlue(color);
        }
