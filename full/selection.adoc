...
NOTE: This section describes features added to the `switch` statement in versions starting with Java 12.  Most new `switch` features became permanent in Java 14, with pattern matching becoming permanent in Java 21.
