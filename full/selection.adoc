...
NOTE: This section describes the "basic" `switch` statement as it was defined in versions before Java 12.  <<_enhanced_switch_statements>> describes enhancements made in Java 12 and subsequent versions.
...
NOTE: This section describes features added to the `switch` statement in versions starting with Java 12.

WARNING: This section is under construction.

===== `switch` expressions

CAUTION: New in Java 12 (preview) / Java 14 (permanent).
...
CAUTION: New in Java 13 (preview) / Java 14 (permanent).

===== Pattern matching

CAUTION: New in Java 17 (preview) / Java 21 (permanent).
