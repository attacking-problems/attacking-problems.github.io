...
_This section describes the "basic" `switch` statement as it was defined in versions before Java 12.  <<_enhanced_switch_statements>> describes enhancements made in Java 12 and subsequent versions._
...
This section describes features added to the `switch` statement in versions starting with Java 12.  Most new `switch` features became permanent in Java 14, with pattern matching becoming permanent in Java 21.
