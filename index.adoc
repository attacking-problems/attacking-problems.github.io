...
* [ ] Move the introduction of `instanceof` from Interfaces (Chapter 10) to Polymorphism (Chapter 18).  Add binding variable and `switch` examples.
* [ ] Add discussion of the `record` feature to Classes (Chapter 9). 
